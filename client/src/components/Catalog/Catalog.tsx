export const Catalog = () => {
    return (
        ...
        <div className="mt-[30px] flex flex-col text-center">
            <h1 className='text-center text-2xl font-semibold leading-7 text-gray-900'>Каталог товаров</h1>
    ...
    <div className=" mt-10 grid grid-cols-1 md:lg:xl:grid-cols-3 group bg-white shadow-xl shadow-neutral-100 border ">
    ...
    <p className="text-xl font-medium text-slate-700 mt-3">Категория</p>
...
<div className="p-10 flex flex-col items-center text-center group     hover:bg-slate-50 cursor-pointer">
    ...
    <p className="text-xl font-medium text-slate-700 mt-3">Категория</p>
    <p className="mt-2 text-sm text-slate-500">Кол-во товаров
    </p>
    </div>
      </div>
        </div>
