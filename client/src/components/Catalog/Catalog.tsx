...
export const Catalog = () => {
    ...
    <div key={el.id} className="p-10 flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:bg-slate-50 cursor-pointer">
        ...
        <p className="text-xl font-medium text-slate-700 mt-3">{el.title}</p>
